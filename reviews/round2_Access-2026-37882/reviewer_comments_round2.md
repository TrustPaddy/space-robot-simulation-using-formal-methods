...
| A15 | q/dq im Modell in umgekehrter Gelenkreihenfolge → Kollisionsmonitor prüfte falsche Armstellung, K6 falsche Grenzen, K9 falsche Paare τ_i·q̇_j | `SpaceRobot.slx` | Modell korrigiert, Abbildungen neu (A60) | ✅ |
...
| A60 | Modellbilder (Abb. 3–6, 8) vom 17.05.2026, vor A15 und vor den Blöcken für Messrauschen, Störmoment, p_tot-Logging und robotP. Kollisionstest (Abb. 9) zeigte altes Modell: Sättigung ±1 N m, Episode lief nach dem Kontakt mit Moment null bis 8,5 s weiter | Sec. III-C, Sec. V, Abb. 3–6, 8, 9 | Layout in `SpaceRobot.slx` aufgeräumt (Patrick, nur Layout). Neue Funktion `makeModelFigures.m` (space-robot-rl, `src/kpi`): Vektorexport der fünf Diagramme mit geladenen Workspace-Variablen, Kollisionstest ohne Agent: (A) Start in Kollision → Abbruch nach dem ersten Agentenschritt, (B) konstante Momente 0,2/0,6/0,4/0,5 N m → Warnung 8,0 s, Kontakt 8,1 s, Moment null und Ende 8,2 s. Abb. 9 neu (d_min und Momente), Text und Captions angepasst. Bei größeren Momenten kommt der Kontakt ohne vorherige Warnung (steht im Text) (24.09.2026) | ✅ |
| A61 | Endkontrolle Zahlen: alle Mittel-±-Std-Zellen von Tab. 8, 10, 11, 12, 14, 15 automatisch gegen die CSVs geprüft (Skript im Scratchpad), Tab. 7, 9, 13 und alle Textzahlen von Hand. 12 Tabellenzellen um eine Stelle falsch gerundet (doppeltes Runden), u. a. SAC K4 in Tab. 8 (0,144 statt 0,145), Ablation K9 bei W_v und W_ωb, Stresstest TRPO K4 bei Parameter × 1,5 (0,021). Text: „p ≤ 0,031“ (max. 0,0312) und „K2 stayed at“ (stieg von 0,00415) | Tab. 8, 11, 12, 14, Sec. VI, VII-D | Korrigiert. Lernkurven- und Quaternion-Zahlen per MATLAB nachgerechnet, stimmen. Overfull-Boxen bei K6, K9 und Tab. 3 behoben, die Box aus \maketitle kommt aus der Klasse. Offen: Momentum-Maxima in Sec. V („< 1e-6 N s in 620 Episoden“, „bis 4,3e-4 N s“, Tracking A23/A27 nennt 3e-4) sind in keiner Ergebnisdatei gespeichert, Prüfung nur durch Neusimulation (24.09.2026). Gelöst ohne Neusimulation: Maxima und „620 Episoden“ gestrichen, jetzt qualitativ („no systematic drift … within the numerical tolerance of the solver“, größere Abweichungen bei schnell wechselnden Momenten), Offset 2,7e-7 N s aus Abb. 7 bleibt (26.09.2026) | ✅ |
| A62 | Änderungen Prof. Kaigom (Commits 20a540f, 8675b1f, 0b1acf0 vom 26.09.2026): neuer Titel, Abstract auf 250 Wörter gekürzt (FFSR, „deep RL“), Keyword EASI, „Frankfurt University of Applied Sciences“ aus Abb. 1 gestrichen, drei neue Referenzen (La 2025, Kaigom/Roßmann TII 2021, Kaigom TII 2024), neuer Einstieg in Sec. VIII, Satz zur Seed-Robustheit in den Limitations, Biografie. Response Letter als `access/Response to the Reviewers.docx` | Titel, Abstract, Keywords, Abb. 1, Sec. I, II (Beiträge), III-A, VIII, Literatur, Biografie | In Markierungsversion übernommen und markiert (Biografie nur per Kommentar, `\hl` bricht in IEEEbiography). Referenzen ins IEEE-Format gebracht (Band, Heft und Heftjahr per Crossref geprüft), die zwei TII-Referenzen hinter [muhlbauer2025towards] einsortiert. Doppeltes „therefore“ im PPO-Beitrag, „dependence of PPO on seed“ und „therefore“ in den Limitations umformuliert, „(easi)“ → „(EASI)“, Zeilen neu umbrochen. Beide PDFs neu gebaut (26.09.2026) | ✅ |
| A63 | Highlighted PDF mit 330 Markierungen und 60 Kennungen, interne A-Nummern für Reviewer unverständlich. Abstract: „a FFSR“, „formal“ vor „check of torque saturation“ fehlte (Response Letter sagt „formal check“), Kopfzeile passte nicht zum neuen Titel | Markierungsversion, Abstract, Kopfzeile, Response Letter | Nur noch Markierungen mit Reviewer-Bezug (139), A-Nummern aus den Tags entfernt, R2.4a/b → R2.4. Titel als [R2.5], neuer Einstieg Sec. VIII und „not a definitive ranking“ als [R2.3]. Einzelne Tabellenzellen (A61) und reine A-Stellen entmarkiert, Text unverändert (Wortvergleich). Abstract: „an FFSR“, „a formal check …, but is not a formal proof“ (weiter 250 Wörter). Titel nach Rücksprache „Benchmarking Deep Reinforcement Learning With Runtime Safety Monitoring for Cartesian Path Tracking of Free-Floating Space Robot Manipulators“ (Beitrag als Benchmark vorne, R2), Kopfzeile „Benchmarking Deep RL With Runtime Safety Monitoring for Free-Floating Space Manipulators“. Response Letter: Legende „Note on the highlighted manuscript“ nach der Einleitung, R2-Nummern in den sechs Punkten und in der Übersichtstabelle (26.09.2026) | ✅ |
| A64 | Uni-Wechsel Patrick zur TU Darmstadt (ab WiSe 2026/27), Forschung vollständig an der Frankfurt UAS | Autorenblock, Biografie | Affiliation bleibt Frankfurt UAS. E-Mail patrick.ermisch@proton.me statt stud.fra-uas.de. Biografie: B.Eng. Mechatronik (Gesamtnote „sehr gut“, 2026), M.Sc. Mechatronik mit Schwerpunkt Robotik an der TU Darmstadt, 4× Dean’s List, doppelter Name am Anfang entfernt. Zweiter Absatz nach LinkedIn-Profil: Student Research Assistant Quantenmechanik-Projekt (2023–2026), Tutor Physik I/II, Regelungstechnik, Robotik & ML, Mensch-Roboter-Interaktion, SEW-Praktikum AGV-Pfadplanung (statt „mobile application“), ESA-Kurs ECSS (ESEC-Galaxia, 2026). Nicht markiert (kein Reviewer-Bezug). „Present address“ bewusst weggelassen, ggf. bei der finalen Fassung. `access/access-submission.zip` neu gebaut (26.09.2026) | ✅ |
