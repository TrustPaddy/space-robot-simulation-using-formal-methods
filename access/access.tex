...
lowest jerk ($K_7$), with the shortest training time ($T_2$). DDPG attains the lowest maximum error ($K_3$). TRPO
...
\begin{itemize}
        \item PPO shows the most favorable combination of training stability (low $T_1$), training time ($T_2$),
