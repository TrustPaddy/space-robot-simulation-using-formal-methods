...
\textbf{Ranking of the Algorithms.} \cref{tab:reward_ranking} shows TRPO, the default PPO agent, and SAC
...
to a few perturbation levels and two reference paths \cite{b8}.
