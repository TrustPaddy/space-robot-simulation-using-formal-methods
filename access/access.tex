...
algorithms (TRPO, TD3, SAC, PPO, PG, and DDPG) for planar Cartesian path tracking of a FFSR in a
...
runtime monitors for selected properties and a check of torque saturation, but does not constitute a
formal proof of closed-loop safety.
\end{abstract}
\begin{keywords}
