...
\author{\uppercase{Patrick S. Ermisch}\authorrefmark{1}, \IEEEmembership{Fellow, IEEE} and 
\uppercase{Eric Guiffo Kaigom\authorrefmark{2}} \IEEEmembership{Member, IEEE}}
...
introduce unique control challenges compared to terrestrial robots \cite{b1}. 
...
An expensive fuel (e.g., hydrazine ($N_2H_4$)) consumption  and  excitation of the robot dynamics for some activation 
frequencies of the pulse width modulation for thruster control can be avoided \cite{b11}.
\\ \\
...
These challenges motivate the development and simulation of AI-empowered digital twins under desired operational condition to
...
The work presented in this paper investigates the use of continuous-action deep RL for a free-floating space
manipulator. It differs from previous contribution in three ways. First, it focuses on a systematical comparison 
of different RL algorithms beyond those mentioned in \cref{tab:sample}, thereby quantitatively and qualitatively 
...
account the minimization of the base attitude. We are not aware of any previous work that compares DL algorithms 
for the path tracking of free-floating space robots while considering the base attitude minimization and unifying 
constrain monitoring through formal methods, to the best of our knowledge (see, also \cref{tab:sample}). The key 
...
\begin{figure}[H]
    ...
    \begin{subfigure}{\columnwidth}
        \centering
        \includegraphics[width=\columnwidth]{Figures/ref_kreisbahn_1.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{\columnwidth}
        \centering
        \includegraphics[width=\columnwidth]{Figures/ref_kreisbahn_2.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{\columnwidth}
        \centering
        \includegraphics[width=\columnwidth]{Figures/ref_kreisbahn_3.png}
    \end{subfigure}
