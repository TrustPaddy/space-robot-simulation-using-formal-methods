...
\begin{figure}[!t]
	...
	\end{subfigure}
	\caption{Gradual hybrid testbeds integrate AI-driven digital twins (left) with physical robotic systems (right), providing a framework for studying policy optimization and domain-randomization strategies for sim-to-real transfer.}
	\label{fig:oos}
\end{figure}
