...
\title{Benchmarking  Deep Reinforcement Learning for Cartesian Path Tracking  of Free-Floating Space Robot Manipulators Using  Digital Twins}
...
of key performance indexes related to the training duration and stability, tracking accuracy, base attitude disturbance, motion smoothness, energy consumption, and collision risks. 
...
Building on this result, we quantify the effect of systematic PPO tuning (neural network architecture and key hyperparameters) on both a circular and ramp-shaped Cartesian path of the end-effector.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{Figures/spacerobot_slx_robot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{Figures/spacerobot_slx_reference.png}
...
\begin{figure}[H]
    \centering   
    \includegraphics[width=0.7\linewidth]{Figures/spacerobot_slx_redardfcn.png}
...
imminent), the system triggers a collision event \cite{b31}. In our simulation, we set, e.g., $d_{safe} = 5$ cm as the minimum clearance. When triggered, the following occurs: (1) a warning flag is
...
\begin{figure}[H]
    \centering    
    \includegraphics[width=0.5\linewidth]{Figures/verify_tau_slx.png}
...
\bibitem{b33}
S. A. A. Moosavian and E. Papadopoulos, ``Free-flying robots in space: an overview of dynamics modeling, planning and control,''
\emph{Robotica}, vol. 25, no. 5, pp. 537--547, 2007, doi: 10.1017/S0263574707003438.
