...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Validation of the desired end effector circular path using inverse kinematics}
...
\end{figure}
\noindent
The Simulink model is organized into modular subsystems, as illustrated schematically in~\autoref{fig:spacerobot_slx}
