...
\begin{abstract}
\hlone{[R2.1, R2.2, R2.3, A37, A45, A47, A51, A52] Free-floating space robots exhibit a strong dynamic
coupling between manipulator motion and base attitude, which complicates Cartesian path tracking of the
end-effector. Labeled on-orbit data for supervised learning are scarce. This work therefore benchmarks six
reinforcement learning (RL) algorithms (TRPO, TD3, SAC, PPO, PG, and DDPG) for planar Cartesian path
tracking of a free-floating space robot in a physics-based Simulink/Simscape environment with runtime
safety monitoring. Each configuration is trained with ten seeds, and success rate and performance of
successful runs are evaluated separately with unified metrics. With default hyperparameters, only TRPO
completes all ten runs without a safety abort, whereas the other agents terminate 40\% to 80\% of their
evaluation episodes. Even in their successful runs, SAC, DDPG, and TD3 track the path with a
...
masses, inertias, and damping uniformly increased by 50\%. All results are obtained in simulation under
controlled assumptions and do not establish operational readiness. The safety component comprises
runtime monitors for selected properties and a formal check of the torque saturation, not a formal
...
\begin{figure}[!t]
	...
	\end{subfigure}
	\caption{\hlone{[A44] Concept of a hybrid testbed for in-space robotic services. An AI-driven digital twin (left)
	is linked to the physical setup at Frankfurt University of Applied Sciences (right). This work covers only the
	simulation side, and the physical setup is intended for future sim-to-real studies. Illustration created with
	GPT-Image-2 from a photograph of the physical setup.}}
	\label{fig:oos}
\end{figure}
...
\cite{kaigom2025deep}, as illustrated in \cref{fig:oos}. Unlike standard DTs that primarily mirror sensed
...
Mean Base Orientation Error ($K_4$) & $0.026 \pm 0.009$ & $0.145 \pm 0.092$ & $0.098 \pm 0.080$ &
...
\begin{table*}[t]
    ...
    \begin{tabular}{lcccccc}
        ...
        $W_p = 0$ & 5/5 & $-6.79 \pm 1.41$ & $0.2592 \pm 0.0552$ & $0.014 \pm 0.005$ &
          $0.0046 \pm 0.0007$ & $0.56 \pm 0.30$ \\
        $W_v = 0$ & 5/5 & $-0.26 \pm 0.18$ & $0.0054 \pm 0.0030$ & $0.033 \pm 0.025$ &
          $0.0088 \pm 0.0013$ & $1.99 \pm 0.42$ \\
        ...
        $W_d = 0$ & 5/5 & $-0.27 \pm 0.19$ & $0.0063 \pm 0.0042$ & $0.035 \pm 0.025$ &
        ...
        $k_b = 0$ ($r_{\mathrm{bonus}}$ off) & 5/5 & $-0.23 \pm 0.09$ & $0.0057 \pm 0.0042$ &
          $0.031 \pm 0.018$ & $0.0095 \pm 0.0011$ & $2.03 \pm 0.43$ \\
        \bottomrule
    \end{tabular}
\end{table*}
...
\begin{table*}[t]
    ...
    \begin{tabular}{lccccccccc}
        ...
        Torque limit $0.3\,\tau_{\max}$ & $0.01488 \pm 0.0197$ & $0.026 \pm 0.010$ & $0.00489 \pm 0.0031$ &
          $0.021 \pm 0.015$ & 8 & 9 & 7 & 5 & 2 \\
        External disturbance & $0.01289 \pm 0.0145$ & $0.066 \pm 0.024$ & $0.00506 \pm 0.0028$ &
          $0.055 \pm 0.023$ & 5 & 4 & 2 & 3 & 2 \\
        Parameters $\times 1.5$ & $0.02847 \pm 0.0267$ & $0.022 \pm 0.008$ & $0.01421 \pm 0.0061$ &
          $0.019 \pm 0.011$ & 7 & 7 & 5 & 3 & 2 \\
        Combined & $0.02790 \pm 0.0228$ & $0.058 \pm 0.021$ & $0.01434 \pm 0.0060$ & $0.049 \pm 0.021$ &
          6 & 7 & 5 & 4 & 2 \\
        \bottomrule
    \end{tabular}
\end{table*}

\textbf{TRPO and Optimized PPO Agent.} \hlone{[R2.2, R2.3, A2, A3, A39, A40, A52] Both agents completed all runs without a terminated episode under
...
optimized PPO agent and from 0.026 to 0.066 for TRPO, while $K_2$ stayed at 0.00506 and 0.01289. The
...
default hyperparameters, and tuning them might change their ranking.} \hlone{[R2.3] Third, the}
